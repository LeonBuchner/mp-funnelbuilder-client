...
const metricCards: ReadonlyArray<MetricCardDef> = [
  {
    key: 'views',
    label: 'Besuche',
    tooltip: 'Gesamtanzahl der Aufrufe dieses Funnels im gewaehlten Zeitraum.',
  },
  {
    key: 'leads',
    label: 'Neue Conversions',
    tooltip: 'Anzahl der Besucher, die zu Leads wurden (Formular ausgefuellt).',
  },
  {
    key: 'conversion_rate',
...
function formatInteger(value: number): string {
  // toLocaleString fuer Tausendertrennzeichen (1234 -> "1.234" in de-DE).
  // Fuer die erwarteten Metriken-Groessenordnungen im Renderer unkritisch.
 ...
 * toFixed(2) ist environment-unabhaengig, replace('.', ',') liefert deutsches Format.
 */
