      ...
      >
        ...
        <div class="max-h-[60vh] overflow-y-auto px-6 py-4">
          ...
          >
            ...
            <button
              type="button"
              class="mt-2 block w-full text-ui-accent hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ui-accent"
              @click="loadMembers"
            >
              Erneut versuchen
            </button>
            ...
            >
              ...
              <div class="flex items-center gap-3">
                ...
                <button
                  ...
                  :aria-label="isLastAdmin(members, member.id)
                    ...
                    : `${member.name} entfernen`"
                  class="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-lg text-ui-muted transition-colors hover:bg-red-50 hover:text-red-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 disabled:cursor-not-allowed disabled:opacity-40"
              ...
              >
                ...
                <div class="flex gap-2">
                  <button
                    type="button"
                    class="rounded-md px-3 py-1 text-xs font-medium text-ui-muted transition-colors hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ui-accent"
                    @click="cancelRemove"
                  >
                    Abbrechen
                  </button>
                  <button
                    type="button"
                    :disabled="isRemoving"
                    class="rounded-md bg-red-600 px-3 py-1 text-xs font-medium text-white transition-colors hover:bg-red-700 disabled:opacity-60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-red-500"
                    @click="handleRemove"
                  >
