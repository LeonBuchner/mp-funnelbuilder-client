    ...
    <div class="flex flex-wrap items-center gap-3 border-b border-ui-border px-5 py-4">
      ...
      >
        ...
        <template v-if="metrics.status === 'draft'">
          <button
            type="button"
            class="rounded-lg bg-ui-accent px-3 py-1.5 text-xs font-medium text-white transition-colors hover:bg-ui-accent-hover disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-ui-accent"
            :disabled="isActing"
            @click="handleStart"
          >
            Starten
          ...
          <button
            type="button"
            class="rounded-lg border border-ui-border px-3 py-1.5 text-xs font-medium text-red-600 transition-colors hover:border-red-300 hover:bg-red-50 disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500"
            :disabled="isActing"
            @click="askDelete"
          >
            Löschen
        ...
        <template v-else-if="metrics.status === 'running'">
          <button
            type="button"
            class="rounded-lg border border-ui-border px-3 py-1.5 text-xs font-medium text-ui-text transition-colors hover:border-ui-accent/40 hover:text-ui-accent disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ui-accent"
            :disabled="isActing"
            @click="handlePause"
          >
            Pausieren
      ...
      <button
        type="button"
        class="shrink-0 rounded p-1 text-ui-muted transition-colors hover:text-ui-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ui-accent"
          ...
          <tbody class="divide-y divide-ui-border">
            ...
            >
              ...
              >
                <button
                  type="button"
                  class="rounded-lg border border-ui-border px-3 py-1.5 text-xs font-medium text-ui-text transition-colors hover:border-ui-accent/40 hover:text-ui-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ui-accent disabled:cursor-not-allowed disabled:opacity-50"
