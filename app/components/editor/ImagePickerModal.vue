...
function tabButtonCls(tab: ActiveTab): string {
  const base = 'px-4 py-2.5 text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-inset focus:ring-ui-accent/30'
          ...
          <div v-else>
            ...
            >
              ...
              <button
                v-if="!isReadonly"
                type="button"
                class="mt-2 text-sm text-ui-accent hover:underline focus:outline-none focus:ring-1 focus:ring-ui-accent/50"
                @click="activeTab = 'upload'"
              >
            ...
            <div v-else>
              <div class="grid grid-cols-3 gap-3 sm:grid-cols-4">
                ...
                >
                  ...
                  <button
                    ...
                    type="button"
                    class="absolute bottom-1.5 right-1.5 z-10 rounded-md bg-white/90 p-1 text-red-500 opacity-0 shadow transition-opacity hover:bg-white hover:text-red-600 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-red-400/50 group-hover:opacity-100"
                  ...
                  >
                    ...
                    <div class="flex gap-1.5">
                      <button
                        type="button"
                        class="rounded px-2.5 py-1 text-xs font-medium bg-red-600 text-white transition-colors hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500/50"
                      ...
                      <button
                        type="button"
                        class="rounded border border-ui-border px-2.5 py-1 text-xs font-medium text-ui-text transition-colors hover:bg-ui-bg focus:outline-none focus:ring-2 focus:ring-ui-accent/30"
              ...
              >
                <button
                  ...
                  class="rounded-lg border border-ui-border px-4 py-2 text-sm text-ui-muted transition-colors hover:border-ui-accent hover:text-ui-text focus:outline-none focus:ring-2 focus:ring-ui-accent/30 disabled:cursor-not-allowed disabled:opacity-50"
                  @click="loadMore"
                >
