...
<template>
  ...
  >
    ...
    >
      ...
      <button
        type="button"
        class="flex h-8 w-8 items-center justify-center text-ui-muted transition-colors hover:bg-ui-bg hover:text-ui-text focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-ui-accent"
        title="Duplizieren"
      ...
      <button
        ...
        class="flex h-8 w-8 items-center justify-center text-ui-muted transition-colors hover:bg-ui-bg hover:text-ui-text focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-ui-accent disabled:cursor-not-allowed disabled:opacity-30"
        title="Nach oben"
      ...
      <button
        type="button"
        class="flex h-8 w-8 items-center justify-center text-red-400 transition-colors hover:bg-red-50 hover:text-red-600 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-red-500"
        title="Löschen"
    ...
    >
      ...
      <button
        ...
        type="button"
        role="menuitem"
        class="flex w-full items-center gap-2 px-3 py-1.5 text-left text-sm text-ui-text hover:bg-ui-bg focus-visible:bg-ui-bg focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-ui-accent"
