    ...
    <div class="flex min-w-0 flex-1 items-center gap-2">
      ...
      <template v-if="isEditingName">
        <input
          ...
          v-model="editName"
          type="text"
          class="min-w-0 max-w-[240px] rounded border border-ui-accent bg-white px-2 py-1 text-sm font-semibold text-ui-text focus:outline-none focus:ring-2 focus:ring-ui-accent"
